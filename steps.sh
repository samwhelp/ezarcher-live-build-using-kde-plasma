...
##
## ``` sh
## sudo IS_DEBUG=true ./skel.sh kde-plasma
## ```
##
## run
##
## ``` sh
## sudo REF_MAIN_RUN=test IS_DEBUG=true ./skel.sh kde-plasma
## ```
##
...
args_var_init () {
	...
	DEFAULT_BUILD_RESPIN="kde-plasma"
...
model_var_init () {
	...
	REF_ISO_PROFILE_REPO_GIT_URL="https://github.com/samwhelp/ezarcher-live-build-config-template-kde-plasma.git"

	#REF_ISO_PROFILE_REPO_ARCHIVE_URL="https://github.com/samwhelp/ezarcher-live-build-config-template-kde-plasma/archive/refs/heads/main.zip"
	REF_ISO_PROFILE_REPO_ARCHIVE_URL="https://github.com/samwhelp/ezarcher-live-build-config-template-kde-plasma/archive/refs/heads/main.tar.gz"


	REF_ISO_PROFILE_REPO_ARCHIVE_FILE_NAME="main.tar.gz"
	REF_ISO_PROFILE_REPO_ARCHIVE_EXTRACT_DIR_NAME="ezarcher-live-build-config-template-kde-plasma-main"
...
msg_usage_body_locale () {
	...
	util_error_echo
	util_error_echo "Example  : sudo REF_BUILD_LOCALE=zh_tw ./${REF_CMD_FILE_NAME} kde-plasma"
	util_error_echo
...
msg_usage_body_arch () {
	...
	util_error_echo
	util_error_echo "Example  : sudo REF_BUILD_ARCH=amd64 ./${REF_CMD_FILE_NAME} kde-plasma"
	util_error_echo
